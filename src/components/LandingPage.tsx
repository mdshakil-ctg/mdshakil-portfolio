...
const LandingPage = () => {
  return (
    <main className='lg:min-h-screen bg-[#212428] lg:fixed lg:left-0 lg:w-1/2 text-white font-semibold p-12'>
      ...
      <div>
        <h1 className='text-3xl md:text-6xl'>Hi, I am <span className='text-[#FF014F]'>Mohammed Shakil</span> <br /> Software Engineer.</h1>
        <p className='text-sm text-slate-600 my-4'>I am the Front-End Developer for #Company in Bangladesh, OR. I have serious passion for UI effects, animations and creating intuitive, dynamic user experiences.</p>
      </div>
